...
slug: sample-post
title: Sample Post
date: 2021-10-01T07:35:03.431Z
author: abdullahi-mahamed
description: Markdown is the most popular markup language that can be used to
  format documents. It can be used to create websites, ebooks, email, chats in
  discussions forums.
tags:
  - funding
  - finance
