---
slug: basic-of-markdown
title: Basics Of Markdown
date: 2021-12-07T13:21:13.133Z
description: >
  Markdown is the most popular markup language that can be used to format
  documents. It can be used to create websites, ebooks, email, chats in
  discussions forums.
---
